...
export const api = {
  ...
  sessions: {
    ...
    quickSearch: (q: string) =>
      `${API_BASE_URL}/api/quick-search${qs({ q })}`,
  },
  ...
  // ── API Keys ──────────────────────────────────────────────────────────────
  apiKeys: {
    list: () => `${API_BASE_URL}/api/api-keys`,
    globalList: () => `${API_BASE_URL}/api/global/api-keys`,
    delete: (keyId: string) => `${API_BASE_URL}/api/api-keys/${keyId}`,
  },
