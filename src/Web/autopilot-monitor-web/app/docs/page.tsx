        ...
        <div className="px-4 py-4 space-y-3 text-sm text-gray-700">
          ...
          <div>
            ...
            <div className="mt-1 bg-gray-50 border border-gray-200 rounded px-3 py-2 text-xs font-mono space-y-0.5">
              ...
              <p className="text-gray-400">... and more (see agent source)</p>
            </div>
          </div>
      ...
      <div className="border border-gray-200 rounded-lg overflow-hidden">
        ...
        <div className="px-4 py-4 space-y-3 text-sm text-gray-700">
          ...
          <div>
            <p className="font-medium text-gray-900">Parameters</p>
            <ul className="list-disc ml-5 space-y-1">
              <li><code className="bg-gray-100 px-1 rounded">readContent</code> — Set to <code className="bg-gray-100 px-1 rounded">true</code> to read file content (files must be &lt;50 KB, content truncated to 4000 chars).</li>
            </ul>
          </div>
          <div>
