  ...
  return (
    <section className="bg-white rounded-lg shadow-md p-8">
      ...
      <SettingsGroup title="Agent Parameters" color="bg-violet-50 text-violet-900" borderColor="border-violet-200">
        ...
        <SettingsRow name="Set Timezone Automatically" defaultVal="Disabled">
          Only available when Geo-Location Detection is enabled. Automatically sets the device timezone based on
          the IP geolocation result using <span className="font-mono text-xs bg-gray-100 px-1.5 py-0.5 rounded">tzutil /s</span>.
          Useful for shared device scenarios where devices may be enrolled in different time zones.
        </SettingsRow>
        ...
        <SettingsRow name="Log Level" defaultVal="Info">
          ...
          troubleshooting, <strong>Verbose</strong> produces a full trace of every internal operation, and{" "}
          <strong>Trace</strong> enables full diagnostic output including low-level details.
        ...
        <SettingsRow name="Show Enrollment Summary" defaultVal="Disabled">
          ...
          Requires the SummaryDialog companion to be deployed alongside the agent. When enabled, the following
          sub-settings become available:
        </SettingsRow>
      ...
      <SettingsGroup title="Agent Analyzers" color="bg-orange-50 text-orange-900" borderColor="border-orange-200">
        ...
        <SettingsRow name="Software Inventory &amp; Vulnerability Analyzer" defaultVal="Disabled">
          <span className="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-semibold bg-emerald-100 text-emerald-700 border border-emerald-200 mr-1">Experimental</span>
          <span className="inline-flex items-center px-1.5 py-0.5 rounded text-xs font-semibold bg-amber-100 text-amber-700 border border-amber-200 mr-1">Pre-Release</span>
